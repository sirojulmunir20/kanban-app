...
func (a *modifyWeb) AddTask(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: answer here
	filePath1 := path.Join("views", "main", "add-task.html")
	filePath2 := path.Join("views", "general", "header.html")
	tmpl, _ := template.ParseFS(a.embed, filePath1, filePath2)
...
func (a *modifyWeb) AddCategory(w http.ResponseWriter, r *http.Request) {
	// TODO: answer here
	filePath1 := path.Join("views", "main", "add-category.html")
	filePath2 := path.Join("views", "general", "header.html")
	tmpl, _ := template.ParseFS(a.embed, filePath1, filePath2)
...
func (a *modifyWeb) UpdateTask(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: answer here
	filePath1 := path.Join("views", "main", "update-task.html")
	filePath2 := path.Join("views", "general", "header.html")
	tmpl, _ := template.ParseFS(a.embed, filePath1, filePath2)
